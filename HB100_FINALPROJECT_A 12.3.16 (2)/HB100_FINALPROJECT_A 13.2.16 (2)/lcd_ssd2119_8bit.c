...
//
//*****************************************************************************
static void LCD_SSD2119PixelDraw(void *pvDisplayData, int lX, int lY,
...
//
//*****************************************************************************
static void LCD_SSD2119PixelDrawMultiple(void *pvDisplayData, int lX, int lY,
		int lX0, int lCount, int lBPP, const unsigned char *pucData,
...
//
//*****************************************************************************
static void LCD_SSD2119LineDrawH(void *pvDisplayData, int lX1, int lX2, int lY,
		unsigned int ulValue) {
	//
	// Set the cursor increment to left to right, followed by top to bottom.
	//
...
//
//*****************************************************************************
static void LCD_SSD2119LineDrawV(void *pvDisplayData, int lX, int lY1, int lY2,
		unsigned int ulValue) {
	//
...
//
//*****************************************************************************
static void LCD_SSD2119RectFill(void *pvDisplayData, const tRectangle *pRect,
		unsigned int ulValue) {
	int lCount;
...
//
//*****************************************************************************
static unsigned int LCD_SSD2119ColorTranslate(void *pvDisplayData,
		unsigned int ulValue) {
	//
...
//
//*****************************************************************************
static void LCD_SSD2119Flush(void *pvDisplayData) {
	//
...
//
//*****************************************************************************
const tDisplay g_sLCD_SSD2119 = { sizeof(tDisplay), 0,
#if defined(PORTRAIT) || defined(PORTRAIT_FLIP)
		240,
		320,
#else
		320, 240,
#endif
		LCD_SSD2119PixelDraw, LCD_SSD2119PixelDrawMultiple,
		LCD_SSD2119LineDrawH, LCD_SSD2119LineDrawV, LCD_SSD2119RectFill,
		LCD_SSD2119ColorTranslate, LCD_SSD2119Flush };
