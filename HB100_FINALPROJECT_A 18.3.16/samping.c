...
#else
#pragma DATA_ALIGN(ucControlTable, UDMA_XFER_MAX*2)
unsigned char ucControlTable[UDMA_XFER_MAX * 2];
#endif
...
SAMPLING_ADC adcNode[2] =
		{ { .g_uiSamplingFreq = 26000, .g_ucDataReady = 0, .g_ulBadPeriphIsr1 =
...
void ADC3IntHandler(void) {
	...
	static unsigned long ulNextuDMAXferSize = 0;
